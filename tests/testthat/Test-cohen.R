...
res <- cohen(m1,m2,sd1,sd2,n1,n2,conf.level=.95,var.equal=T,unbiased=F, alternative="two.sided")
...
res2 <- cohen(m1,m2,sd1,sd2,n1,n2,conf.level,var.equal,unbiased, alternative)
res1 <- datacohen(Group.1,Group.2,conf.level,var.equal,unbiased, alternative,na.rm)
